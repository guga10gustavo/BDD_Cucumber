package br.com.alura.leilao.acceptence.steps;
...
public class LeilaoSteps {
	...
	public void prenche_o_formulario_com_dados_validos() {
		this.leiloesPage = novoLeilaoPage.preencheForm("PC Novo", "1500", "01/01/2020");
	...
	public void o_novo_leilao_aparece_na_tabela() {
		this.leiloesPage.existe("PC Novo", "1500", "01/01/2020","fulano");
	    this.browser.clean();
	}
